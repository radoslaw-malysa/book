...
const stateBg = {
  pending: { bg: 'border-l-amber-500 bg-amber-500/7 hover:bg-amber-700/7', txt: 'text-amber-600 dark:text-amber-400' },
  confirmed: { bg: 'border-l-emerald-500 bg-emerald-500/7 hover:bg-emerald-700/7', txt: 'text-emerald-600 dark:text-emerald-400' },
